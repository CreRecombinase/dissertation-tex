...
Unlike the marginalized likelihood without the normalized-genotype assumption, this form lends itself to efficient computation and parameter estimation. By
