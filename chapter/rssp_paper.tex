...
variants was only estimated for variants within 1,703 approximately independent LD blocks (as previously identified in the 1000 genomes EUR population using the method ldetect\cite{ldetect}).
...
\subsection{Application to large-scale GWAS}
